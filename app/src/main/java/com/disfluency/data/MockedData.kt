...
object MockedData {
    ...
    val patients: MutableList<Patient> = arrayListOf(
        Patient("Agustin", "Cragno", LocalDate.of(1998, 7, 30), 40123864, "acragno@frba.utn.edu.ar", LocalDate.of(2023, 1, 9), R.drawable.avatar_26, listOf(Day.MONDAY, Day.THURSDAY), LocalTime.of(18, 0), assignments),
        Patient("Jose", "Bruzzoni", LocalDate.of(1991, 2, 3), 43181238, "jbruzzoni@frba.utn.edu.ar", LocalDate.of(2018, 12, 9), R.drawable.avatar_12, listOf(Day.TUESDAY, Day.THURSDAY), LocalTime.of(19, 0), assignments),
        Patient("Alexander", "Martinez", LocalDate.of(1995, 5, 4), 37186477, "amartinez@gmail.com", LocalDate.of(2023, 5, 15), R.drawable.avatar_17, listOf(Day.WEDNESDAY), LocalTime.of(19, 0), assignments)
    )
